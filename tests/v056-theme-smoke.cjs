  ...
  try{
    ...
    const visual=await page.evaluate(()=>{
      ...
      return {bodyClass:document.body.classList.contains('dnd-theme-v056'),fox:!!fox,snake:!!snake,
        ...
        ornamentRight:fb.right,ornamentBottom:fb.bottom,ornamentTop:fb.top,
    ...
    assert.equal(visual.ornamentRight,'auto');assert.equal(visual.ornamentBottom,'auto');assert.equal(visual.ornamentTop,'-10px');
