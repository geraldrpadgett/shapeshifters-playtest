...
for(const name of ['shifters-v043-patch.js','shifters-v043-patch.css','shifters-v044-patch.css','shifters-v046-layout.css','shifters-v047-trigger-fix.js']){
...
html=html.replace(/v0\.4\.0 Stable Tabletop/g,'v0.4.7 Reference Layout + Trigger Timing');
...
console.log('Built Shapeshifters v0.4.7 reference tabletop and trigger timing into dist/');
